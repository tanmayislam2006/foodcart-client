  ...
  const handleGoogleLogin = () => {
    googleLogin()
      .then((result) => {
        ...
        fetch(`https://foodcart-server-eight.vercel.app/user/${user?.uid}`)
          .then((res) => res.json())
          .then((data) => {
            ...
            if (!availableUser) {
              ...
              fetch("https://foodcart-server-eight.vercel.app/register", {
                method: "POST",
                headers: {
        ...
        if (user) {
          ...
          fetch("https://foodcart-server-eight.vercel.app/login", {
            method: "PATCH",
            headers: {
              "content-type": "application/json",
            },
